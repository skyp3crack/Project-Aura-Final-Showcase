...
## 🏆 Award
**2nd Runner Up - Gamuda AI Academy Cohort 4 Demo Day Capstone Project Competition**
...
**AI & Cloud:**
`Google Gemini` `Google Cloud` `LangChain`

**Frontend & UI:**
`Vite` `TailwindCSS` `Material UI` `Socket.IO`

**Deployment & Utilities:**
`Firebase` `PWA` `License`
...
📧 **Contact:** For source code access or collaboration inquiries, please reach out via [email](mailto:cheefeng21@gmail.com) or [LinkedIn](https://www.linkedin.com/in/lewcheefeng/).
...
🎬 [**View Personality Analysis Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View Additional AI Features Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View Messaging Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View Matching Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View Profile Setup Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View AI Advisor Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View PWA Features Demo**](YOUR_DEMO_LINK_HERE)
...
🎬 [**View UI/UX Demo**](YOUR_DEMO_LINK_HERE)
...
*   **Report Issues:** [GitHub Issues](https://github.com/GAIA-Team-Aura/Project-Aura-Portfolio/issues) (You might need to create this repo first)
*   **Feedback:** Open an issue for suggestions or questions

### For Source Code Access
*   **Email:** [cheefeng21@gmail.com](mailto:cheefeng21@gmail.com)
*   **LinkedIn:** [Lew Chee Feng](https://www.linkedin.com/in/lewcheefeng/)
*   **GitHub:** [Christian Lew](https://github.com/christian-lew)
